...
class FragmentTab5 : Fragment() {
    ...
    //    val tabName = context?.getSharedPreferences("harshappsco.com.testilityjira.TABNAMES", Context.MODE_PRIVATE)?.getString("TAB5", "null")

        val tableCol = IssueEntry.ISSUE_TAB_LANE_COL + " = ?" + "OR " +
                IssueEntry.ISSUE_TAB_LANE_COL + " = ?" + "OR " +
                IssueEntry.ISSUE_TAB_LANE_COL + " = ? "
        val whereSel = arrayOf("10033","10040","10010")
