...
class FragmentTab4 : Fragment() {
    ...
    //    val tabName = context?.getSharedPreferences("harshappsco.com.testilityjira.TABNAMES", Context.MODE_PRIVATE)?.getString("TAB4", "null")
        ...
        val whereSel = arrayOf("10015","10020","10007","10025","10021","10042","10041","10039")
