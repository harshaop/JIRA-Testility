...
data class IssueDataList(val issueID: String, val summary: String , val description: String, val tabCol : String, val typUrl: String , val prioUrl: String, val assigneeUrl :String?)